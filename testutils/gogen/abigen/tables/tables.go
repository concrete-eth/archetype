...
// RowDataCounter is an auto generated low-level Go binding around an user-defined struct.
type RowDataCounter struct {
	Value int16
}
...
func (_Contract *ContractCaller) GetCounter(opts *bind.CallOpts) (RowDataCounter, error) {
	...
	out0 := *abi.ConvertType(out[0], new(RowDataCounter)).(*RowDataCounter)
