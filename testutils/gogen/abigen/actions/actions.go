...
// ActionDataAdd is an auto generated low-level Go binding around an user-defined struct.
type ActionDataAdd struct {
	Summand int16
}

// ContractMetaData contains all meta data concerning the Contract contract.
var ContractMetaData = &bind.MetaData{
	ABI: "[{\"type\":\"function\",\"name\":\"add\",\"inputs\":[{\"name\":\"action\",\"type\":\"tuple\",\"internalType\":\"structActionData_Add\",\"components\":[{\"name\":\"summand\",\"type\":\"int16\",\"internalType\":\"int16\"}]}],\"outputs\":[],\"stateMutability\":\"nonpayable\"},{\"type\":\"event\",\"name\":\"ActionExecuted\",\"inputs\":[{\"name\":\"actionId\",\"type\":\"bytes4\",\"indexed\":false,\"internalType\":\"bytes4\"},{\"name\":\"data\",\"type\":\"bytes\",\"indexed\":false,\"internalType\":\"bytes\"}],\"anonymous\":false}]",
}
...
// Add is a paid mutator transaction binding the contract method 0x4f70db79.
//
// Solidity: function add((int16) action) returns()
func (_Contract *ContractTransactor) Add(opts *bind.TransactOpts, action ActionDataAdd) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "add", action)
}

// Add is a paid mutator transaction binding the contract method 0x4f70db79.
//
// Solidity: function add((int16) action) returns()
func (_Contract *ContractSession) Add(action ActionDataAdd) (*types.Transaction, error) {
